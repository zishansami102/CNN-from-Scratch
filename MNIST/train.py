...
## Data extracting
m =10000
X = extract_data('CNN-from-Scratch/MNIST/t10k-images-idx3-ubyte.gz', m, IMG_WIDTH)
y_dash = extract_labels('CNN-from-Scratch/MNIST/t10k-labels-idx1-ubyte.gz', m).reshape(m,1)
X-= int(np.mean(X))
X/= int(np.std(X))
...
m =50000
X = extract_data('CNN-from-Scratch/MNIST/train-images-idx3-ubyte.gz', m, IMG_WIDTH)
y_dash = extract_labels('CNN-from-Scratch/MNIST/train-labels-idx1-ubyte.gz', m).reshape(m,1)
